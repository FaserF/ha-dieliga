# AI Agent Reference for ha-dieliga
...
| Area | Path |
|---|---|
| Integration Entry | `custom_components/dieliga/__init__.py` |
| API Client | `custom_components/dieliga/api.py` |
| Coordinator | `custom_components/dieliga/coordinator.py` |
| Platforms | `custom_components/dieliga/sensor.py`, `custom_components/dieliga/binary_sensor.py`, `custom_components/dieliga/calendar.py` |
| Tests | `tests/` |
...
- **Timezone Awareness**: All calendar event datetimes must be timezone-aware (e.g. using `dt_util.as_local`).
